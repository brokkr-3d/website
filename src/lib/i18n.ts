...
const STRINGS: Record<Locale, Dict> = {
  en: {
    ...
    "contact.form.error": "Something went wrong. Please email us instead.",
    "contact.form.disabled": "The message form isn’t set up yet — email us directly:",
  ...
  no: {
    ...
    "contact.mapLink": "Åpne i Google Maps",
    "contact.formHeading": "Send en melding",
    ...
    "contact.form.success": "Takk — vi svarer deg snart.",
    "contact.form.error": "Noe gikk galt. Send oss en e-post i stedet.",
    "contact.form.disabled": "Meldingsskjemaet er ikke satt opp ennå — send oss en e-post direkte:",
